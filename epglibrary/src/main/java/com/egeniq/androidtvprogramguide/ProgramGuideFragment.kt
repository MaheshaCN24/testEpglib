...
abstract class ProgramGuideFragment<T> : Fragment(), ProgramGuideManager.Listener,
    ...
    protected open val DISPLAY_LOCALE = Locale("en", "IN")
    protected open val DISPLAY_TIMEZONE: ZoneId = ZoneId.of("Asia/Kolkata")
    protected open val SELECTABLE_DAYS_IN_PAST = 0
    ...
    private val current_date_time = view?.findViewById<TextView>(R.id.current_date_time)
    ...
    override fun onCreateView(
        ...
        handler.postDelayed(object : Runnable {
            override fun run() {
                updateTime(view)
                handler.postDelayed(this, 1 * 1000) // Schedule the next update in 1 minute
            }
        }, 1 * 1000)
    ...
    private fun updateTime(view: View){
        ...
        val textView = view?.findViewById<TextView>(R.id.current_date_time)
