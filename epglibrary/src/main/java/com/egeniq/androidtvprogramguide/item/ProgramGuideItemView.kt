...
class ProgramGuideItemView<T> : FrameLayout {
    ...
    private val program_info: TextView
    private val program_time: TextView
    init {
        View.inflate(context, R.layout.programguide_item_program, this)

        titleView = findViewById(R.id.title)
        program_info = findViewById(R.id.item_info)
        program_time = findViewById(R.id.time)
    }
    ...
    fun setValues(
        ...
        title =
            if (title?.isEmpty() == true){
                resources.getString(R.string.programguide_title_no_program)
            } else title
    ...
    fun seBackgroundColor(color: Int) {
        this.seBackgroundColor(color)
    }
